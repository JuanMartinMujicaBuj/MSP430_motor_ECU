...
//
// Modified by J. M. Mujica Buj (10/2022)
//
...
//                        SPI MOSI -->| MOSI           | 0V -->| GND        |  | | 120 Ohm  | BUS
//                        SPI MISO <--| MISO           | 5V -->| VCC        |  | |          |
//                       SPI Clock -->| SCK(Max 10MHz) |       |            |   -           |
//                                    |                |       |            |   |           |
//                    Ceramic 8MHz -->| OSC            |       |       CANH |<------------->|
//                                     ----------------         ------------                 -------
//                                        (MCP2515)               (TJA1050)
//              
//
...
#ifndef F_CPU
#define F_CPU       1000000  //For a frequency of 1 MHz                          // Frequenz mit der die CPU arbeitet
...
#define MCP2515_CS_LOW   P2OUT &=~ BIT5 //Pin for chip select (to start and end communication with mcp2515 via spi)
...
//Note: the only functions that should be used are MCP2515_init(),
//MCP2515_CanVariable_init(), MCP2515_can_tx0(), MCP2515_can_rx0().
//All of the others might be used for debug, otherwise they should
